...
def list_permission_roles(data):
        ...
        try:
            ...
            if "roles" in current_acl:
                for role, details in current_acl["roles"].items():
                    if "subjects" in details and permission in details["permissions"]:
                ...
                signature = {"signature": signature.hex(), "permission roles" : roles_with_permission }
